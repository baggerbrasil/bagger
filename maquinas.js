const categorias = {
  ...
  imagens: [
    'uploads/elevador1.png',
    'uploads/elevador2.png',
    'uploads/elevador3.png'
  ],
  ...
  recursos: [
    'Eixo direcional flutuante reforçado',
  ...
  descricao:
    'Pá carregadeira elétrica compacta equipada com bateria de lítio LFP, ideal para movimentação de materiais, carregamento e transporte interno com zero emissões e baixo custo operacional.',
  ...
  autonomia: '7 h',
  preco: 'Sob consulta',
  badge: 'Pá Carregadeira Elétrica',
  especificacoes: [
    ...
    { label: 'Volume da Caçamba Traseira', valor: '0,52 m³' },
    ...
    { label: 'Tempo de Carga', valor: '5 horas' },
    { label: 'Bateria', valor: '73,6V / 240Ah (LFP)' },
    { label: 'Capacidade da Bateria', valor: '17,7 kWh' },
    { label: 'Tensão Nominal', valor: '73,6 V' },
    { label: 'Sistema Hidráulico', valor: 'AC 4,5 kW' },
    { label: 'Pressão Hidráulica', valor: '16 MPa' },
    { label: 'Direção', valor: 'Totalmente Hidráulica' },
    { label: 'Pneus', valor: '26×12.00-12' },
    { label: 'Quantidade de Pneus', valor: '4' },
    { label: 'Freio de Serviço', valor: 'Tambor' },
    { label: 'Freio de Estacionamento', valor: 'Tambor Manual' }
  ],
  recursos: [
    'Bateria de lítio LFP de alta durabilidade',
    'Autonomia operacional de até 7 horas',
    'Carregamento completo em aproximadamente 5 horas',
    'Direção totalmente hidráulica',
    'Velocidade de deslocamento de até 20 km/h',
    'Caçamba principal de 0,25 m³',
    'Caçamba traseira basculante de 0,52 m³',
    'Capacidade traseira de 1.000 kg',
    'Operação silenciosa e sem emissões',
    'Baixo custo de manutenção',
    'Raio de giro reduzido para operações em áreas confinadas'
  ]
}
    ]
  },
...
categorias.plataforma = {
  ...
  maquinas: maquinasDumper.filter((maquina) => ['MPGKT', 'GTJZ1416'].includes(maquina.modelo))
};
